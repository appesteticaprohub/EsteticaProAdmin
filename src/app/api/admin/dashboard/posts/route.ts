  ...
  try {
    ...
    switch (period) {
      ...
      case 'today':
        ...
        // Posts de ayer para comparación
      ...
      case 'month':
        ...
        label = 'Posts Publicados (Mes)'
        break

      case 'year':
        // Posts publicados este año
